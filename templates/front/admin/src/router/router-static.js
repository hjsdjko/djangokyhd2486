...
import center from '@/views/center'
    ...
    import luyongjieguo from '@/views/modules/luyongjieguo/list'
    ...
    import zhiweizhaopin from '@/views/modules/zhiweizhaopin/list'
