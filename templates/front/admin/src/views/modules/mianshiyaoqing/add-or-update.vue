<template>
	<div class="addEdit-block" :style='{"width":"100%","padding":"0px 30px 30px","fontSize":"14px","color":"#000","background":"none"}'>
		...
		>
			<template >
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-if="type!='info'" label="邀请编号" prop="yaoqingbianhao">
					<el-input v-model="ruleForm.yaoqingbianhao" placeholder="邀请编号" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-else-if="ruleForm.yaoqingbianhao" label="邀请编号" prop="yaoqingbianhao">
					<el-input v-model="ruleForm.yaoqingbianhao" placeholder="邀请编号" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-if="type!='info'"  label="职位类型" prop="zhiweileixing">
					<el-input v-model="ruleForm.zhiweileixing" placeholder="职位类型" clearable  :readonly="ro.zhiweileixing"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-else class="input" label="职位类型" prop="zhiweileixing">
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="date" v-if="type!='info'" label="面试时间" prop="mianshishijian">
					<el-date-picker
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-else-if="ruleForm.mianshishijian" label="面试时间" prop="mianshishijian">
					<el-input v-model="ruleForm.mianshishijian" placeholder="面试时间" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="date" v-if="type!='info'" label="提交时间" prop="tijiaoshijian">
					<el-date-picker
						value-format="yyyy-MM-dd HH:mm:ss"
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-else-if="ruleForm.tijiaoshijian" label="提交时间" prop="tijiaoshijian">
					<el-input v-model="ruleForm.tijiaoshijian" placeholder="提交时间" readonly></el-input>
				</el-form-item>
			</template>
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="textarea" v-if="type!='info'" label="邀请备注" prop="yaoqingbeizhu">
					<el-input
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-else-if="ruleForm.yaoqingbeizhu" label="邀请备注" prop="yaoqingbeizhu">
					<span :style='{"padding":"0 20px","color":"inherit","background":"none","display":"inline-block","fontSize":"14px","lineHeight":"40px","fontWeight":"500"}'>{{ruleForm.yaoqingbeizhu}}</span>
				</el-form-item>
