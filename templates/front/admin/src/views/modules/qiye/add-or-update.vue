	...
	<div class="addEdit-block" :style='{"width":"100%","padding":"0px 30px 30px","fontSize":"14px","color":"#000","background":"none"}'>
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-if="type!='info'"  label="企业行业" prop="qiyexingye">
					<el-input v-model="ruleForm.qiyexingye" placeholder="企业行业" clearable  :readonly="ro.qiyexingye"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-else class="input" label="企业行业" prop="qiyexingye">
					<el-input v-model="ruleForm.qiyexingye" placeholder="企业行业" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-if="type!='info'"  label="法人代表" prop="farendaibiao">
					<el-input v-model="ruleForm.farendaibiao" placeholder="法人代表" clearable  :readonly="ro.farendaibiao"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-else class="input" label="法人代表" prop="farendaibiao">
					<el-input v-model="ruleForm.farendaibiao" placeholder="法人代表" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-if="type!='info'"  label="企业邮箱" prop="qiyeyouxiang">
					<el-input v-model="ruleForm.qiyeyouxiang" placeholder="企业邮箱" clearable  :readonly="ro.qiyeyouxiang"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-else class="input" label="企业邮箱" prop="qiyeyouxiang">
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="date" v-if="type!='info'" label="注册时间" prop="zhuceshijian">
					<el-date-picker
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-else-if="ruleForm.zhuceshijian" label="注册时间" prop="zhuceshijian">
