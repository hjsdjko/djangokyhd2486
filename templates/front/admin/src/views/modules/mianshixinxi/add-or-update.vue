	...
	<div class="addEdit-block" :style='{"width":"100%","padding":"0px 30px 30px","fontSize":"14px","color":"#000","background":"none"}'>
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' class="input" v-if="type!='info'"  label="招聘岗位" prop="zhiweileixing">
					<el-input v-model="ruleForm.zhiweileixing" placeholder="招聘岗位" clearable  :readonly="ro.zhiweileixing"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"100%","margin":"0 0 30px 0","fontSize":"inherit","color":"inherit"}' v-else class="input" label="招聘岗位" prop="zhiweileixing">
					<el-input v-model="ruleForm.zhiweileixing" placeholder="招聘岗位" readonly></el-input>
				</el-form-item>
