<template>
	<div class="main-content" :style='{"color":"#666","padding":"0px 30px 30px","fontSize":"14px"}'>
				...
				@selection-change="selectionChangeHandler">
					...
					<el-table-column width="300" label="操作">
						<template slot-scope="scope">
							...
							<el-button class="btn8" v-if="isAuth('mianshixinxi','录用结果')" @click="luyongjieguoCrossAddOrUpdateHandler(scope.row,'cross','','','','')" type="success">
		...
		<luyongjieguo-cross-add-or-update v-if="luyongjieguoCrossAddOrUpdateFlag" :parent="this" ref="luyongjieguoCrossaddOrUpdate"></luyongjieguo-cross-add-or-update>
...
import luyongjieguoCrossAddOrUpdate from "../luyongjieguo/add-or-update";
	export default {
		data() {
			return {
				searchForm: {
				...
				luyongjieguoCrossAddOrUpdateFlag: false,
		...
		methods: {
			...
			luyongjieguoCrossAddOrUpdateHandler(row,type,crossOptAudit,crossOptPay,statusColumnName,tips,statusColumnValue){
				this.showFlag = false;
				this.addOrUpdateFlag = false;
				this.luyongjieguoCrossAddOrUpdateFlag = true;
				this.$storage.set('crossObj',row);
				this.$storage.set('crossTable','mianshixinxi');
				...
				if(statusColumnName!=''&&!statusColumnName.startsWith("[")) {
					...
					for (var o in obj){
						if(o==statusColumnName && obj[o]==statusColumnValue){
							...
							this.showFlag = true;
							this.luyongjieguoCrossAddOrUpdateFlag = false;
							return;
						}
					}
				}
				this.$nextTick(() => {
					this.$refs.luyongjieguoCrossaddOrUpdate.init(row.id,type);
				});
			},
