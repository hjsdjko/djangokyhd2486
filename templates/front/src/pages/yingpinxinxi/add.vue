...
<div :style='{"width":"80%","padding":"20px","margin":"10px auto","position":"relative","background":"#fff"}'>
    ...
    >
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}' label="应聘岗位" prop="zhiweileixing">
            <el-input v-model="ruleForm.zhiweileixing" 
                placeholder="应聘岗位" clearable :disabled=" false  ||ro.zhiweileixing"></el-input>
          </el-form-item>
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}' label="个人简历" prop="gerenjianli">
            <file-upload
            tip="点击上传个人简历"
            action="file/upload"
            :limit="1"
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}' label="个人经历" prop="gerenjingli">
            <el-input
              type="textarea"
              :rows="8"
              placeholder="个人经历"
