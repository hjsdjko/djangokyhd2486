...
<div :style='{"width":"80%","padding":"20px","margin":"10px auto","position":"relative","background":"#fff"}'>
    ...
    >
          ...
          <el-form-item :style='{"padding":"10px","margin":"0 0 10px","background":"none"}' label="招聘岗位" prop="zhiweileixing">
            <el-input v-model="ruleForm.zhiweileixing" 
                placeholder="招聘岗位" clearable :disabled=" false  ||ro.zhiweileixing"></el-input>
          </el-form-item>
